      ...
      <form className="form d-flex flex-center">
        <div className="card-body mw-800px py-20">
          ...
          <div className="row">
            <label className="col-xl-3"></label>
            <div className="col-lg-9 col-xl-6">
              <h5 className="fw-bold mb-6">Updates From Wareeba:</h5>
            </div>
          </div>
          ...
          <div className="mb-8 row">
            ...
            <div className="col-lg-9 col-xl-6">
              <div className="form-check form-check-custom form-check-solid mb-3">
                ...
                >
                  News about Wareeba products and feature updates
                </label>
              </div>
              <div className="form-check form-check-custom form-check-solid mb-3">
                <input
              ...
              <div className="form-check form-check-custom form-check-solid">
                ...
                >
                  News about Wareeba on partner products and other services
                </label>
              </div>
            </div>
          </div>
